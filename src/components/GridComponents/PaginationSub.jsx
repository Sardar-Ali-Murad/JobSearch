// This is the subPart of the the PaginationMain.jsx where there is the entire Logic for the Advance Pagination
...
function PaginationSub({  setCurrentPage }) {
  ...
  return (
    <div className="pagination-container">
      <AiFillCaretLeft
        // href="#"
        className={`${currentButton === 1 ? 'disabled preBtn' : 'preBtn'}`}
      ...
      {arrOfCurrButtons.map(((item, index) => {
        ...
        //   href="#"
          ...
          className={`${paginationPage === item ? 'active' : ''}`}
      ...
      <AiFillCaretRight
        // href="#"
        className={`${currentButton === numberOfPages.length ? 'disabled nextBtn' : 'nextBtn'}`}
